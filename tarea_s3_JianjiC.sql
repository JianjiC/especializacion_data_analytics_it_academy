...
## desactivar foreign key constraints, porque el nuevo registro lleva un "copamy_id" (foreign key)
## que no está en la tabla "compay" y causaría un error de constraints
...
## activar de nuevo foreign key constraints
